//
// Программа демонстрирует использование очереди из стандартной библиотеки
...
typedef queue<string> TaskQueue; // Используемый тип очереди
...
int main()
{
    ...
    while (true)
    {
        ...
        // Использование мьютекса для синхронизации доступа к очереди
        {
            ...
            {
                cout << "Queue is full. Try again later.";
            }
        }
        if (input == "exit")
            break;
